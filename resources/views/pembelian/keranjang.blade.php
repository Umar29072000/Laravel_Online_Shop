                    ...
                    <div class="col-md-12">
                        ...
                        @elseif (request('alert') == 1)
                            <div class="alert alert-success alert-dismissible" role="alert">
                                ...
                                <strong><i class="glyphicon glyphicon-ok-circle"></i> Sukses!</strong> produk berhasil
                                ditambahkan.
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($transactions as $transaction)
                                                <tr>
                                                    ...
                                                    <td width='60'><img
                                                            src="{{ asset('images/barang/' . $transaction->gambar) }}"
                                                            width="150"></td>
                                                    ...
                                                    <td width='120'>Rp. {{ number_format($transaction->jumlah_bayar) }}
                                                    </td>
                        ...
                        @if (count($transactions) > 0)
                            <div class="">
                                ...
                                &nbsp; &nbsp;
                                <a href="{{ route('user.pembelian.checkout') }}"
