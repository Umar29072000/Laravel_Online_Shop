                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" action="{{ route('user.dashboard.update',Auth::user()->id) }}" method="POST" id="edit" style="display: none;">
                                    @csrf
                                    @method('put')
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nama</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control" name="kabkota" id="kabkotaDropdown"
                                                ...
                                                <option value="{{ $data->kota }}">{{ $data->kabkota->nama_kabkota }}</option>
