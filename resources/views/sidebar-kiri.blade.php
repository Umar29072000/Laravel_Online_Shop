        ...
        @foreach ($featuredProducts as $data)
            <div class="media">
                <div class="media-left">
                    <a href="">
                        <img style="margin-top: 5px" class="media-object"
                            src="{{ asset('images/barang/' . $data->gambar) }}" width="100" alt="Warta Terbaru">
                    </a>
                </div>
                <div class="media-body">
                    ...
                    <p>
                        ...
                        @else
                            <a style="width:70px" href="{{ route('user.pembelian.index', ['produk' => $data->id]) }}"
