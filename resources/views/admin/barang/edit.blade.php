                        ...
                        <form class="form-horizontal" role="form" action="{{ route('admin.barang.update', $barang->id) }}"
                            ...
                            <div class="row">
                                <div style="padding-right: 40px" class="col-xs-12 col-md-8">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <input type="text"
                                                ...
                                                name="nama_barang" placeholder="Nama Barang.." autocomplete="off" required
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <textarea class="col-xs-12 col-sm-12 form-control @error('deskripsi') is-valid @enderror" id="ckeditor"
                                                name="deskripsi" required>{{ $barang->deskripsi }}</textarea>
                                            @error('deskripsi')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="input-group">
                                            <input class="form-control date-picker" type="date"
                                                data-date-format="dd-mm-yyyy" name="tanggal_masuk" required
                                    ...
                                    <div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('harga') is-valid @enderror"
                                                name="harga" autocomplete="off" value="{{ $barang->harga }}"
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input type="file" class="form-control"
                                                id="id-input-file-2 @error('gambar') is-valid @enderror" name="gambar" />
                                            <img style="padding: 1px" class="profile-picture"
                                                src="{{ asset('images/barang/' . $barang->gambar) }}
                                    "
                                                width="120">
                                        </div>
                                    </div>
